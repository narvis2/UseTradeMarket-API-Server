...
class ProductService @Autowired constructor(
    ...
    fun search(
        ...
        return when(condition) {
            ...
            NEXT_IN_CATEGORY -> {
                productRepository.findByCategoryIdAndIdLessThanOrderByIdDesc(categoryId, productId, pageable)
            }
            PREV_IN_CATEGORY -> {
                productRepository.findByCategoryIdAndIdGreaterThanOrderByIdDesc(categoryId, productId, pageable)
            }
